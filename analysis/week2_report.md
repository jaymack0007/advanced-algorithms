...
The complete timing table is stored in `benchmarks/results/comparison\\\_table.csv`.

!\[Random Data](../benchmarks/results/random\_data.png)

!\[Sorted Data](../benchmarks/results/sorted\_data.png)

!\[Reverse Data](../benchmarks/results/reverse\_data.png)

!\[Nearly Sorted Data](../benchmarks/results/nearly\_sorted.png)

!\[Many Duplicates](../benchmarks/results/many\_duplicates.png)

!\[Few Unique Values](../benchmarks/results/few\_unique.png)
